...
BEST_CFG: Dict[str, Dict[str, Any]] = {
    ...
    "ednet_kt1_gap": {
        # Reuse the previous filtered EdNet run parameters.
        "seed": 42,
        "batch_size": 4096,
        "epochs": 100,
        "learning_rate": 1e-4,
        ...
        "graph_reg_cap_ratio": 6.0,
        "graph_entropy_min": 0.15,
        "graph_entropy_max": 0.8,
        "lambda_graph_diag": 0.1,
        "lambda_graph_uniform": 0.04,
        "graph_uniform_margin": 0.1,
        "graph_dropout": 0.0,
        "graph_tau_init": 0.55,
        "graph_identity_residual": 0.05,
        ...
        "personal_support_include_graph": True,
        "personal_support_include_neighbors": False,
        "personal_item_support_mass": 0.2,
