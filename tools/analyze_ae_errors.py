...
def _build_model(checkpoint: Mapping[str, Any], device: torch.device) -> CognitiveDiagnosisModel:
    ...
    model = CognitiveDiagnosisModel(
        ...
        graph_learnable_edges=_get(loaded_args, "graph_learnable_edges", True),
        ...
        personal_mastery_count_smoothing=_get(loaded_args, "personal_mastery_count_smoothing", 0.0),
        personal_reliability_pref_scale=_get(loaded_args, "personal_reliability_pref_scale", 1.0),
