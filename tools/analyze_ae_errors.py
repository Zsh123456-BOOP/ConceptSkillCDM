...
AE_COMPONENT_KEYS = (
    "ae_stat_student_prior",
    "ae_stat_exercise_prior",
    ...
    "ae_interaction_logit",
    "ae_raw_logit_before_clip",
    "ae_raw_logit_after_clip",
)
        ...
        item.update(
            {
                ...
                "posterior_prior_abs_mean": float(grp["ae_posterior_prior_logit"].abs().mean()),
...
def analyze(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    summary: Dict[str, Any] = {
        ...
        "overall": {
            ...
            "posterior_prior_abs_mean": float(samples["ae_posterior_prior_logit"].abs().mean()),
        },
