...
RECIPES: Dict[str, SplitRecipe] = {
    ...
    "ednet_kt1_gap_small_t70u2000": SplitRecipe(
        name="ednet_kt1_gap_small_t70u2000",
        min_interactions=60,
        max_interactions=600,
        target_users=2000,
        train_frac=0.70,
        valid_frac=0.10,
        seed=20260529,
        rationale="Old-scale AUC-first split: around 0.28M train rows with a meaningful direct-unseen tail.",
    ),
    "ednet_kt1_gap_small_t60u2200": SplitRecipe(
        name="ednet_kt1_gap_small_t60u2200",
        min_interactions=60,
        max_interactions=600,
        target_users=2200,
        train_frac=0.60,
        valid_frac=0.10,
        seed=20260529,
        rationale="Old-scale balanced split: targets the previous EdNet train size while keeping more gap test rows.",
    ),
    "ednet_kt1_gap_small_t50u2600": SplitRecipe(
        name="ednet_kt1_gap_small_t50u2600",
        min_interactions=60,
        max_interactions=600,
        target_users=2600,
        train_frac=0.50,
        valid_frac=0.10,
        seed=20260529,
        rationale="Old-scale gap-first split: similar train size with the largest test tail among small recipes.",
    ),
    "ednet_kt1_gap_small_t65u1200_long": SplitRecipe(
        name="ednet_kt1_gap_small_t65u1200_long",
        min_interactions=120,
        max_interactions=900,
        target_users=1200,
        train_frac=0.65,
        valid_frac=0.10,
        seed=20260529,
        rationale="Old-scale long-history split: richer histories with train size close to the prior 0.26M split.",
    ),
}
