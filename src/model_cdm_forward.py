...
def run_cdm_forward(
    ...
    details: Dict[str, torch.Tensor] = {
        ...
        "roadmap_theta_e_adjustment": theta_calibration_details["roadmap_theta_e_adjustment"].detach(),
        "tutor_theta_e_adjustment": theta_calibration_details["tutor_theta_e_adjustment"].detach(),
        "theta_e_calibration_delta": theta_calibration_details["theta_e_calibration_delta"].detach(),
        "roadmap_theta_e_reliability": theta_calibration_details["roadmap_theta_e_reliability"].detach(),
        "tutor_theta_e_reliability": theta_calibration_details["tutor_theta_e_reliability"].detach(),
        ...
        "support_candidate_size_mean": s_out.get("support_candidate_size_mean", torch.tensor(0.0, device=device)).detach(),
        "support_final_size_mean": s_out.get("support_final_size_mean", torch.tensor(0.0, device=device)).detach(),
        "support_item_survival_rate": s_out.get("support_item_survival_rate", torch.tensor(0.0, device=device)).detach(),
        "support_seq_survival_rate": s_out.get("support_seq_survival_rate", torch.tensor(0.0, device=device)).detach(),
        "support_item_seq_overlap": s_out.get("support_item_seq_overlap", torch.tensor(0.0, device=device)).detach(),
        "support_self_retention_rate": s_out.get("support_self_retention_rate", torch.tensor(0.0, device=device)).detach(),
    ...
    if model.use_personal_graph:
        ...
        for key in (
            ...
            "personal_recent_mastery_scores_absmean",
