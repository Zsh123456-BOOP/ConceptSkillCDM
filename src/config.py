...
DATASET_DEFAULTS = {
    "assist_09": {
        ...
        "graph_query_readout_scale": 0.10,
        "graph_query_readout_2hop_scale": 0.04,
        ...
        "personal_mastery_prior_scale": 1.4,
        "personal_recent_mastery_prior_scale": 0.7,
        ...
        "personal_query_correction_scale": 0.35,
        ...
        "roadmap_theta_calibration_scale": 0.12,
    ...
    "assist_17": {
        ...
        "personal_query_correction_max_ratio": 0.35,
        ...
        "relation_theta_scale": 0.0,
        "relation_theta_delta_clip": 2.0,
        "roadmap_theta_calibration_scale": 0.10,
        "tutor_theta_calibration_scale": 0.18,
        "theta_calibration_clip": 0.75,
        "ae_posterior_prior_scale": 1.0,
        "ae_posterior_theta_scale": 0.0,
        "graph_query_adapter_enable": True,
    ...
    "junyi": {
        ...
        "relation_theta_delta_clip": 2.0,
        "roadmap_theta_calibration_scale": 0.10,
        "tutor_theta_calibration_scale": 0.16,
        "theta_calibration_clip": 0.75,
        "ae_posterior_prior_scale": 1.0,
        "ae_posterior_theta_scale": 0.0,
        "graph_query_adapter_enable": True,
...
DATASET_DEFAULTS["nips34"] = {
    **PUBLIC_BENCHMARK_DEFAULTS,
    ...
    "learning_rate": 0.001,
    "graph_prior_logit_scale": 0.45,
    "graph_query_readout_scale": 0.30,
    "graph_query_readout_2hop_scale": 0.10,
    "graph_propagation_alpha": 0.18,
    "personal_delta_scale": 3.0,
    "personal_mastery_prior_scale": 1.0,
    "personal_recent_mastery_prior_scale": 0.5,
    "personal_query_correction_scale": 0.18,
    "personal_query_correction_max_ratio": 0.30,
    "personal_query_correction_min_graph_anchor": 0.04,
    "personal_query_row_budget": 1.1,
    "personal_neighbor_row_budget": 0.30,
    "ae_logit_residual_scale": 0.80,
    "roadmap_logit_residual_scale": 0.70,
    "tutor_logit_residual_scale": 1.20,
    "ae_irt_logit_scale": 1.00,
    "roadmap_theta_calibration_scale": 0.10,
    "tutor_theta_calibration_scale": 0.18,
    "theta_calibration_clip": 0.75,
