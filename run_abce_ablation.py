...
STRUCTURAL_SWITCH_KEYS = (
    ...
    "roadmap_theta_calibration_scale",
    "tutor_theta_calibration_scale",
    "theta_calibration_clip",
    "graph_query_adapter_enable",
...
def parse_log_metrics(log_file: Optional[Path]) -> Dict[str, Any]:
    out: Dict[str, Any] = {
        ...
        "ae_posterior_prior_logit_abs_mean": None,
        "ae_posterior_prior_delta_abs_mean": None,
                ...
                for key in (
                    ...
                    if v is not None:
                        mapped = {
                            ...
                            "ae_posterior_prior_logit": "ae_posterior_prior_logit_abs_mean",
                            "ae_posterior_prior_delta": "ae_posterior_prior_delta_abs_mean",
                        }.get(key, key)
                        out[mapped] = v
...
def write_summary(
    ...
    for (dataset, seed, profile), mp in sorted(grouped.items()):
        ...
        row = {
            ...
            "full_personal_item_support_mass": try_float(full.get("personal_item_support_mass")),
            "full_personal_mastery_prior_scale": try_float(full.get("personal_mastery_prior_scale")),
            "full_personal_recent_mastery_prior_scale": try_float(full.get("personal_recent_mastery_prior_scale")),
            ...
            "full_roadmap_logit_residual_scale": try_float(full.get("roadmap_logit_residual_scale")),
            "full_tutor_logit_residual_scale": try_float(full.get("tutor_logit_residual_scale")),
            "full_ae_logit_residual_clip": try_float(full.get("ae_logit_residual_clip")),
            "full_ae_irt_logit_scale": try_float(full.get("ae_irt_logit_scale")),
            "full_ae_interaction_logit_scale": try_float(full.get("ae_interaction_logit_scale")),
            "full_ae_logit_dim": try_float(full.get("ae_logit_dim")),
            "full_ae_posterior_prior_scale": try_float(full.get("ae_posterior_prior_scale")),
            "full_ae_lr_mult": try_float(full.get("ae_lr_mult")),
            "full_ae_stat_prior_scale": try_float(full.get("ae_stat_prior_scale")),
            ...
            "full_ae_posterior_prior_logit_abs_mean": try_float(full.get("ae_posterior_prior_logit_abs_mean")),
            "full_ae_posterior_prior_delta_abs_mean": try_float(full.get("ae_posterior_prior_delta_abs_mean")),
            ...
            "full_personal_item_support_added_rate": try_float(full.get("personal_item_support_added_rate")),
            "full_personal_item_support_added_mass": try_float(full.get("personal_item_support_added_mass")),
    ...
    summary_fields = [
        ...
        "full_personal_mastery_prior_scale",
        "full_personal_recent_mastery_prior_scale",
        ...
        "full_roadmap_logit_residual_scale",
        "full_tutor_logit_residual_scale",
        "full_ae_logit_residual_clip",
        "full_ae_irt_logit_scale",
        "full_ae_interaction_logit_scale",
        "full_ae_logit_dim",
        "full_ae_posterior_prior_scale",
        "full_ae_lr_mult",
        "full_ae_stat_prior_scale",
        ...
        "full_ae_posterior_prior_logit_abs_mean",
        "full_ae_posterior_prior_delta_abs_mean",
